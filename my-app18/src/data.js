...
/* eslint-disable */
export const orderData = JSON.parse(stringData, (_field, value) => {
    let dupValue = value;
...
// Function to generate dynamic data for performance testing with all fields preserved
export const generateDynamicData = (count) => {
